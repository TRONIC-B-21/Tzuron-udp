...
echo -e "Downloading UDP Service (amd64)"
# Update this URL to your actual amd64 release asset when available
BINARY_URL="${TZURON_BINARY_URL:-https://github.com/TRONIC-B-21/Tzuron-udp/releases/download/TBD/tzuron-linux-amd64}"
